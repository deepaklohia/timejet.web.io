            ...
            mysqli_stmt_bind_param($stmt, "s", $param_fpi );
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    if(mysqli_stmt_num_rows($stmt) == 1 ){  
                        ...
                        $sql = "UPDATE tj_login SET mgr_pwd = ?, reset_password = '0' WHERE forgot_pass_identity = ? AND reset_password = '1' " ;

                        if($stmt = mysqli_prepare($conn, $sql)){
                            mysqli_stmt_bind_param($stmt, "ss", $param_mgr_pwd ,$param_fpi );
