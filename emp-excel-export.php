...
if(isset($_POST["export"])){
     ...
     $fileName = "emp_export_data-" . date('Ymd') . ".xls"; 
     //$filename  = "emp-data.xls" ;
     $result = '';
     ...
     start_time AS 'Start Time', end_time AS 'Stop Time', total_time AS 'Total Time' FROM tj_empdata where emp_id = ? AND mgr_id = ? " ;
